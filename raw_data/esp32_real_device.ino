...
const String deviceId = "ESP32_REAL_001";  // Must match your dashboard device ID
const String deviceName = "My Real ESP32"; // Must match your dashboard device name
const String sensorZoneId = "ZONE_001";    // Must match your zone ID (get this from dashboard)
